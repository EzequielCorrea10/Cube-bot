    ...
    private void Awake()
    {
        ...
        switch (scene.name)
        {
            case "Level2":
                ...
                break;
            case "Level3":
                gameObject.transform.position = new Vector3(gameObject.transform.position.x+0.5f, gameObject.transform.position.y -1, gameObject.transform.position.z);
                break;
            case "Level4":
            ...
            case "Level7":
                ...
                break;
            case "Level9":
                gameObject.transform.position = new Vector3(gameObject.transform.position.x + 5.5f, gameObject.transform.position.y + 1f, 0);
                break;
            case "Level10":
                gameObject.transform.position = new Vector3(gameObject.transform.position.x +2.5f, gameObject.transform.position.y+0.5f, 0);
                break;
            case "Level11":
                gameObject.transform.position = new Vector3(gameObject.transform.position.x + 1.5f, gameObject.transform.position.y + 1.5f, 0);
                break;
